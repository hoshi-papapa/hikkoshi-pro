        ...
        <div class="card-body">
            <form action="{{ route('mypage.update') }}" method="POST">
                ...
                <div class="form-group row">
                    <label for="planned_moving_date" class="col-sm-4 col-form-label">引越予定日</label>
                    <div class="col-sm-8">
                ...
                <div class="form-group row mt-4">
                    <label for="phone_number" class="col-sm-4 col-form-label">電話番号</label>
                    <div class="col-sm-8">
                ...
                <!-- Confirm Password -->
                <div class="form-group row mt-4">
                    <label for="password_confirmation" class="col-sm-4 col-form-label">パスワード（確認用）</label>
                    <div class="col-sm-8">
